#include <examples/modules/NamedFibonacciCheck.h>
...
I3_MODULE(NamedFibonacciCheck);


NamedFibonacciCheck::NamedFibonacciCheck(const I3Context& context) : 
  I3Module(context)
{
  prev_=0;
  prev_prev_=0;
  ...
  AddOutBox("OutBox");
  AddParameter("where",
	       "Where to get my fibonacci on",
	       where_);
	       
}

void 
NamedFibonacciCheck::Configure()
{
  GetParameter("where", where_);
}

void 
NamedFibonacciCheck::Physics(I3FramePtr frame)
{
  // get a reference to whatever sequence service the icetray has put
  // at my disposal
  SequenceService& seq = context_.Get<SequenceService>(where_);
